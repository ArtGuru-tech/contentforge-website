    ...
    <div className="min-h-screen bg-[#0a0e27] text-white font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <div className="glass-card p-6 rounded-xl mb-8 border-l-4 border-[#ffd700]">
          ...
          <section className="mb-8">
            ...
            <div className="glass-card p-6 rounded-xl mb-4 border-l-4 border-amber-500">
              <p className="text-gray-300 mb-4">
                {isFrench
          ...
          <div className="glass-card p-6 rounded-xl mt-12">
            ...
            <p className="text-gray-300 mb-4">
              {isFrench ? (
                <>
                  Si vous avez des questions concernant cet Avertissement sur les Revenus, veuillez nous contacter via notre <Link href="/contact" className="text-[#ffd700] hover:underline font-medium">page de contact</Link>.
                </>
              ) : (
                <>
                  If you have any questions about this Earnings Disclaimer, please contact us through our <Link href="/contact" className="text-[#ffd700] hover:underline font-medium">contact page</Link>.
                </>
              )}
            </p>
            <p className="text-gray-300">
              <strong className="text-[#ffd700]">{isFrench ? "Société :" : "Company:"}</strong> BAKCHICH SAS<br />
