      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-2">
            <strong>{isFrench ? "Date d'entrée en vigueur :" : "Effective Date:"}</strong> {isFrench ? "1er janvier 2025" : "January 1, 2025"}
          </p>
          <p className="text-gray-600 mb-2">
            <strong>{isFrench ? "Fournisseur de Licence :" : "License Provider:"}</strong> ContentForge.cc
          </p>
          <p className="text-gray-600 mb-8">
            <strong>{isFrench ? "Titulaire de Licence :" : "License Holder:"}</strong> {isFrench ? "Acheteur de Produits PLR ContentForge" : "Purchaser of ContentForge PLR Products"}
          </p>
          ...
          <section className="mb-10">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6">
              <p className="text-gray-700">
                <strong className="text-gray-900">{isFrench ? "Important :" : "Important:"}</strong> {isFrench ? "Votre type de licence détermine l'accès à la bibliothèque ContentForge, mais tout produit que vous téléchargez vous est concédé sous licence de façon permanente pour une utilisation commerciale selon ces conditions PLR." : "Your license type determines access to the ContentForge library, but any product you download is licensed to you permanently for commercial use under these PLR terms."}
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-4">
                {isFrench ? (
                  <>
                    Pour toute demande incluant des questions sur les licences, le support technique et les questions juridiques, veuillez <a href="contact" className="text-[#003399] hover:underline font-semibold">nous contacter via notre formulaire de contact</a>.
                  </>
                ) : (
                  <>
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 p-6 rounded-lg">
            ...
            <p className="text-gray-700">
              {isFrench ? (
                <>
                  Cette licence vous accorde de larges droits commerciaux, mais avec responsabilité. Nous vous faisons confiance pour utiliser ces produits de manière éthique et légale. En cas de doute, <a href="contact" className="text-[#003399] hover:underline font-semibold">contactez-nous</a> avant d'agir.
                </>
              ) : (
                <>
