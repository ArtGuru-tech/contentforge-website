      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <h3 className="text-xl font-semibold text-[#003399]">
              ...
              <h3 className="text-xl font-semibold text-[#003399] mt-6">
          ...
          <div className="bg-gray-100 p-6 rounded-lg mt-12">
            ...
            <p className="text-gray-700 mb-2">
              <strong>{isFrench ? "Société :" : "Company:"}</strong> BAKCHICH SAS
            </p>
            <p className="text-gray-700 mb-2">
              <strong>{isFrench ? "Adresse :" : "Address:"}</strong> 60 RUE FRANCOIS IER, PARIS, 75008, France
            </p>
            <p className="text-gray-700 mb-2">
              <strong>{isFrench ? "Immatriculation :" : "Registration:"}</strong> 942 552 274 R.C.S. Paris
            </p>
            <p className="text-gray-700">
              <strong>{isFrench ? "Numéro de TVA :" : "VAT Number:"}</strong> FR37942552274
            </p>
          </div>
        </div>
      </div>
