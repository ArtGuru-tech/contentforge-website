        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>
                <strong>{isFrench ? "Société" : "Company"}</strong> {isFrench ? "(désignée par « la Société », « Nous », « Notre » ou « Nos ») fait référence à" : '(referred to as either "the Company", "We", "Us" or "Our") refers to'} <strong>Bakchich SAS</strong>, 60 Rue François Ier, 75008 Paris, France.
              </li>
              <li>
                <strong>{isFrench ? "Site Web" : "Website"}</strong> {isFrench ? "fait référence à" : "refers to"} <strong>CONTENTFORGE</strong>, {isFrench ? "accessible depuis" : "accessible from"} <a href="https://contentforge.cc/" className="text-[#003399] hover:underline">https://contentforge.cc/</a>
              </li>
              <li>
                <strong>{isFrench ? "Service" : "Service"}</strong> {isFrench ? "fait référence au Site Web." : "refers to the Website."}
              </li>
              <li>
                <strong>{isFrench ? "Vous" : "You"}</strong> {isFrench ? "désigne la personne accédant ou utilisant le Service, ou l'entreprise ou autre entité juridique au nom de laquelle cette personne accède ou utilise le Service, selon le cas." : "means the individual accessing or using the Service, or the company or other legal entity on behalf of which such individual is accessing or using the Service, as applicable."}
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              <li>
                <strong>Google Analytics</strong> — {isFrench ? "pour l'analyse du trafic et de l'utilisation" : "for traffic and usage analytics"}
              </li>
              <li>
                <strong>Microsoft Clarity</strong> — {isFrench ? "pour les cartes de chaleur et les informations comportementales" : "for heatmaps and behavioral insights"}
              </li>
              <li>
                <strong>Google Tag Manager</strong> — {isFrench ? "pour gérer les balises d'analyse et de suivi" : "for managing analytics and tracking tags"}
              </li>
              <li>
                <strong>Invisible reCAPTCHA</strong> — {isFrench ? "pour protéger notre site Web contre le spam et les abus" : "to protect our website from spam and abuse"}
              </li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              {isFrench ? (
                <>
                  Vous avez le droit d'accéder, de corriger ou de supprimer vos données personnelles. Vous pouvez en faire la demande en <a href="contact" className="text-[#003399] hover:underline font-semibold">nous contactant</a>.
                </>
              ) : (
                <>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              {isFrench ? (
                <>
                  Si vous avez des questions concernant cette Politique de Confidentialité, veuillez <a href="contact" className="text-[#003399] hover:underline font-semibold">nous contacter via notre formulaire de contact</a>.
                </>
              ) : (
                <>
